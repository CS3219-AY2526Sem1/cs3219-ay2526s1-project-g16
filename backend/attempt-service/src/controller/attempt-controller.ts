...
export async function getAttemptsByUserId(req: Request, res: Response): Promise<void> {
  try {
    ...
    const attempts: attempt[] = await _getAttemptsByUserId(userId, page, pageSize);
...
export async function getUniqueQuestionsByUserId(req: Request, res: Response): Promise<void> {
  try {
